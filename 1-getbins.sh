...
cd data
wget -O northern_grampians.geojson 'http://data.gov.au/geoserver/ngsc-garbage-collection/wfs?request=GetFeature&typeName=ckan_fa3c31f9_008d_4112_90c0_8d7c02fa95fc&outputFormat=json'
