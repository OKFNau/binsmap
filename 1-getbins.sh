...
cd data
wget -O northern_grampians.geojson 'http://data.gov.au/geoserver/ngsc-garbage-collection/wfs?request=GetFeature&typeName=ckan_f5d810f3_9b62_43c9_9a4e_e3afda01fe62&outputFormat=json'
